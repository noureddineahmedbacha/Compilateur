...
public class Lexical {
...

	{
		...
		//split thee file and return in table 
	...
	public  String keyWord(String line) {
		...
		case "StringMes" : 
			...
			resultat =   word[i] +  ":   mot reserver declaration d'un stringr";
	...
	//check the qamah and space add'em in prg
						...
						String[] sub_word = word[i].split("\\s*<=\\s*");
	 					...
	 					for(int j =0; j< sub_word.length;j++) {
	 						...
	 						word[i] = word[i] +"    " + sub_word[j] + " :  identificateur \n";
	 	 						...
	 	 						word[i] = word[i] +"        " +sub_word[j] + "  :  un nombre reél \n";
