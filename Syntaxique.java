...
public class Syntaxique {
		...
		if ( word[i].isEmpty()) {
			...
			case "StringMes" : 
				...
				if(snl_st(line)) {
					...
					resultat = line + " :   declaration de String \n ";
			...
			case "Finish" : 
				...
				default : 
					...
					if(word[i].startsWith("%..")) resultat =  line + ":   un commentaire";
	...
	public static boolean snl_st(String line) {
